...
Update my exploit according to the new information I found, get a low shell but highly unustable. Check the MSF module, decide to make my exploit as per the MSF module instead of using Metasploit itself. It worked! Get a low shell, escalated privileges in 5 minutes. Done. It's 7 PM, and I've 55 points. Time for another break.
### Cracking 25 pointer
